...
| 44 | Structural Evidence publish/verify | M11-5 `07950cd` | `structural/evidence_service.py` (WIRED) | duplicate artifact-read/verify + `_mesh_input_hash` | F4, F21 | POSSIBLE_DUPLICATION |
...
| --- | --- |
| SINGLE_AUTHORITY | 23 |
| LEGITIMATE_LAYERING | 4 |
| LEGITIMATE_ADAPTER_VARIANTS | 2 |
| INTENTIONAL_SUPERSESSION | 5 |
| INTENTIONAL_INDEPENDENT_VERIFIER | 2 |
| SEMANTIC_DUPLICATION | 10 |
| POSSIBLE_DUPLICATION | 8 |
| AUTHORITY_CONFLICT (latent/overload) | 2 |
| LEGACY_RESIDUE | 4 |
| UNKNOWN | 0 |
