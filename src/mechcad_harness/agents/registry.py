...
class AgentRegistry:
    def __init__(self):
        ...
        self._identities: dict[tuple[str, str], AgentIdentity] = {}
    ...
    def get_identity(self, agent_name: str, agent_version: str) -> AgentIdentity:
        try:
            return self._identities[(agent_name, agent_version)]
        except KeyError as exc:
            raise LookupError(f"unknown agent: {agent_name}@{agent_version}") from exc
