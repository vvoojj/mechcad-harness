...
class FreeCADTransientAssemblyMeasurementProvider:
    ...
    def _execute_in_workspace(
        ...
        script = self._measurement_script(program, request.pairs, part_paths)
    ...
    def _measurement_script(
        ...
        for instance in program.canonical_instances:
            ...
            records.append((instance.instance_id, str(part_paths[instance.part_id]), instance.placement.x_mm, instance.placement.y_mm, instance.placement.z_mm, axis, angle))
        return "\n".join(
            [
                "import FreeCAD, json",
                ...
                "shapes = {}",
                f"records = {records!r}",
                "for instance_id, path, x, y, z, axis, angle in records:",
